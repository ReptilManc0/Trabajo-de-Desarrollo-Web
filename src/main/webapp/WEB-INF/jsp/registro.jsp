        ...
        <header>
            <style>
                ...
                #intro {
                    ...
                    height: 77vh;
                    background-image: url("/images/feature_bg.jpg");
                    height: 80vh; /* Reduce la altura en pantallas más pequeñas */
                ...
                @media (max-width: 1024px) {
                    #intro {
                        height: 120vh; /* Reducir aún más la altura en pantallas de 1024x600 */
                    }
                    .container {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-md-8">
                                ...
                                <form class="bg-white rounded shadow-5-strong p-5">
                                    ...
                                    <!-- Submit button -->
                                    <button type="submit" class="btn btn-danger btn-block" data-mdb-ripple-init>Registrarse</button>
                                </form>
