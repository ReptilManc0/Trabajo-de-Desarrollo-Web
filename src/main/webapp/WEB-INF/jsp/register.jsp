                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-md-8">
                                ...
                                <form class="bg-white rounded shadow-5-strong p-5">
                                    ...
                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        <input type="text" id="txtTel�fono" class="form-control" />
                                        <label class="form-label" for="txtTel�fono">Tel�fono</label>
                                    </div>
                                    <div class="form-outline mb-4" data-mdb-input-init>
                                    ...
                                    <!-- Password input -->
                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        <input type="password" id="txtContrase�a" class="form-control" />
                                        <label class="form-label" for="txtContrase�a">Contrase�a</label>
                                    </div>
